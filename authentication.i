...
%module(target_namespace="authentication") authentication
...
%{
#include "bindings/auto/3.7.x/jsb_authentication_auto.h"
#include "authentication/controller/controller.h"
#include "authentication/PersistentAppData.h"
...
//
%ignore authentication::AuthenticationController::init;
%ignore authentication::AuthenticationController::getLoginDelegate;
%ignore authentication::AuthenticationController::setLoginDelegate;
%ignore authentication::AuthenticationController::onAppleCredentialsUpdated;
